<?php
// Include the head and opening tags
include 'main.php';
?>
                            ...
                            <div class="trending-tittle">
                                ...
                                <div class="trending-animated">
                                    <ul id="js-news" class="js-hidden">
                                        <li class="news-item">Pers Mahasiswa Vellichor</li>
                                        <li class="news-item">Informasi Terbaru</li>
                                        <li class="news-item">Universitas Negeri Manado</li>
                                    </ul>
                                </div>
                            ...
                            <div class="trending-top mb-30">
                                <div class="trend-top-img">
                                    ...
                                    <div class="trend-top-cap">
                                        ...
                                        <h2><a href="berita/berita1.html">Welcome To The Best Model Winner<br> Contest At Look
                                                of the year</a></h2>
                                    </div>
                                </div>
                            </div>
